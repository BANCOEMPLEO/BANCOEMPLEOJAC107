...
namespace BANCOEMPLEOJAC.API.Controllers
{
    ...
    {
        private readonly ICategoriaServicio _modeloCategoria;
        public CategoriaController(ICategoriaServicio categoriaServicio)
        {
            _modeloCategoria = categoriaServicio;
        }
        ...
        public async Task<IActionResult> Lista(string buscar = "NA")
        {
            ...
            try
            {
                ...
                response.Resultado = await _modeloCategoria.Lista(buscar);
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> Obtener(int Id)
        {
            ...
            try
            {
                ...
                response.EsCorrecto = true;
                response.Resultado = await _modeloCategoria.Obtener(Id);
            }
            catch (Exception ex)
            {
                response.EsCorrecto = false;
        ...
        public async Task<IActionResult> Crear([FromBody] CategoriaDTO modelo)
        {
            ...
            try
            {
                ...
                response.EsCorrecto = true;
                response.Resultado = await _modeloCategoria.Crear(modelo);
            }
            catch (Exception ex)
            {
                response.EsCorrecto = false;
        ...
        public async Task<IActionResult> Editar([FromBody] CategoriaDTO modelo)
        {
            ...
            try
            {
                ...
                response.EsCorrecto = true;
                response.Resultado = await _modeloCategoria.Editar(modelo);
            }
            catch (Exception ex)
            {
                response.EsCorrecto = false;
        ...
        public async Task<IActionResult> Eliminar(int Id)
        {
            ...
            try
            {
                ...
                response.EsCorrecto = true;
                response.Resultado = await _modeloCategoria.Eliminar(Id);
            }
            catch (Exception ex)
            {
                response.EsCorrecto = false;
