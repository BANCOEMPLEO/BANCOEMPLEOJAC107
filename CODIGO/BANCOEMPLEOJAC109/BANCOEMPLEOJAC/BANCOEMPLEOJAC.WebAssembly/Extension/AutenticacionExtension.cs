...
namespace BANCOEMPLEOJAC.WebAssembly.Extension
{
        ...
        public async Task ActualizarestadoAutenticacion(SesionDTO sesionUsuario)
        {
            ...
            if (sesionUsuario != null)
            {
                claimsPrincipal = new ClaimsPrincipal(new ClaimsIdentity(new List<Claim>
                {
                    ...
                    //new Claim(ClaimTypes.StateOrProvince, sesionUsuario.Jac.Nombre),
                    //new Claim("NombreJac", sesionUsuario.Jac.Nombre) // Añade tu propio Claim aquí
