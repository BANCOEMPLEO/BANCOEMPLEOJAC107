...
public partial class Bancoempleojac99Context : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DetallePropuesta>(entity =>
        {
            ...
            entity.HasOne(d => d.DetallePropuestAnterior).WithMany(p => p.InverseDetallePropuestAnterior)
                .HasForeignKey(d => d.DetallePropuestAnteriorId)
                .HasConstraintName("FK_DetallePropuesta_DetallePropuesta");

            entity.HasOne(d => d.PropuestServicio).WithMany(p => p.DetallePropuesta)
                .HasForeignKey(d => d.PropuestServicioId)
